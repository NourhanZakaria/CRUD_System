...
function path($go){
    echo "<script>window.location.replace('/CRUD_System/$go')</script>";
}


// function stringValidation($input_value,$rule=null,$job=null, $size = 3)
// {
//     $empty1 = empty($input_value);
//     $empty2 = empty($rule);
//     $empty3 = empty($job);
//     $length = strlen($input_value) < $size;
//     $isstr =is_string($input_value);
//     if ($empty1 == true||$empty2 == true||$empty3 == true || $length == true||$isstr==false) {
//         return true;
//     } else {
//         return false;
//     }
